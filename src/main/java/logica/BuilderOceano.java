...
/**
 * Clase que implementa el patrón de diseño Builder para construir un hábitat de océano.
 */
public class BuilderOceano implements HabitatBuilder {
    ...
    public Habitat build() {
        return new Habitat(tipoSuelo, vegetacion, temperatura, tamaño, TipoHabitat.ACUATICO);
    }
}
